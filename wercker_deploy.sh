...
if [ "$WERCKER_DEPLOYTARGET_NAME" = "dev" ]; then
	sed -i 's!<!-- main-script -->!<script data-main="//localhost:1337/js/src/config" src="//localhost:1337/bower_components/requirejs/require.js" id="main-script"></script>!g' app.xml
