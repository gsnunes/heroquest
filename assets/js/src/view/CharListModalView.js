...
], function (html, NewModalView, CharFormModalView, CharCollection, ListGroupView, ButtonView, ButtonToolbarView, ConfirmModalView) {
	...
	return NewModalView.extend({
		...
		start: function (model) {
			...
			if (hasPiece) {
				...
				gapi.hangout.data.setValue(key, JSON.stringify({id: key, position: {offsetX: (600 + (charLen * 62)), offsetY: 52}, model: model}));
			}
		},
